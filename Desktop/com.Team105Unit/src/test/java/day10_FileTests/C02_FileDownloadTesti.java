...
public class C02_FileDownloadTesti extends TestBase {
    ...
    public void test01(){
        ...
        //3. facebook image.WEBP dosyasını indirelim
        driver.findElement(By.xpath("//a[text()='facebook image.WEBP']")).click();
        ReusableMethods.bekle(5);
        //4. Dosyanın başarıyla indirilip indirilmediğini test edelim
        // Test icin oncelikle dosyanin indirildiginde dosyaYolu ne olacak bunu olusturmaliyiz
        String dosyaYolu= System.getProperty("user.home")+ "\\Downloads\\facebook image.WEBP";
    ...
    public void test02(){
        ...
        String dosyaYolu= System.getProperty("user.home")+ "\\Desktop\\MerhabaJava";
        // Assert edelim
        Assert.assertTrue(Files.exists(Paths.get(dosyaYolu)));
    }
}